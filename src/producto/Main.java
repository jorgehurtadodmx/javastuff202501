        ...
        do {
            try {
                ...
                /*case 2:
                    ...
                    String encontrado = productoRepository.findById(busqueda).toString();
                 ...
                 */
                    case 2:
                        System.out.println("Dame una ID");
                        Long busqueda = sc.nextLong();
                        Producto encontrado = productoRepository.findById(busqueda);
                        if (encontrado != null) {
                            System.out.println("encontrado" + encontrado);
                        } else {
                            System.out.println("producto " + busqueda + " no encontrado");
                        }
                        break;
                    case 3:
                ...
                //necesario volver a inicializar opcion en try catch
                System.out.println("Input invalido, prueba otra vez");
                sc.nextLine();
                opcion = 0;
